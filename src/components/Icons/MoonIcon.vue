<template>
  <svg width="18" height="18" viewBox="0 0 18 18" style="transform: rotate(40deg);" class="sc-a794b73f-1 cfurEx">
    ...
    <g>
      <circle cx="17" cy="9" r="1.5" fill="var(--color-text)"
              style="transform-origin: center center; transform: scale(0);"></circle>
